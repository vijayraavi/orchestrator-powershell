...
using UiPath.Web.Client20198.Models;
...
namespace UiPath.PowerShell.Cmdlets
{
    ...
    public class StartMaintenance : AuthenticatedCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            HandleHttpOperationException(() => Api_19_8.Maintenance.Start(Phase.ToString(), force, shouldKillJobs));

            WriteObject(Api_19_8.Maintenance.GetAdminLogs().ToMaintenanceSetting());
        }
    }
}