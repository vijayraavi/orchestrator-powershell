...
using UiPathWebApi_19_8 = UiPath.Web.Client20198.UiPathWebApi;
...
namespace UiPath.PowerShell.Util
{
    public abstract class AuthenticatedCmdlet : UiPathCmdlet
    {
        ...
        private UiPathWebApi_19_8 _api_19_8;
        ...
        protected UiPathWebApi_19_8 Api_19_8
        {
            get
            {
                if (_api_19_8 == null)
                {
                    var authToken = InternalAuthToken;
                    _api_19_8 = MakeApi<UiPathWebApi_19_8>(authToken, (creds, uri) => new UiPathWebApi_19_8(creds) { BaseUri = uri }, Timeout);
                }
                return _api_19_8;
            }
        }
